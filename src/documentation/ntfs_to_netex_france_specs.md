...
Each Netex file starts with a header containing some informations generated by the programm: 
...
- a city code (5 caracter INSEE code for France). Enventually, the city disctrict can be specified with one or two caracters separated by `-`. For exemple `75056-12`.
