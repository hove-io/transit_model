            ...
            assert_eq!(
                vec![
                    ...
                    objects::StopTime {
                        ...
                        sequence: 3,
                        arrival_time: Some(Time::new(6, 7, 27)),
                        departure_time: Some(Time::new(6, 7, 27)),
                        start_pickup_drop_off_window: None,
                        end_pickup_drop_off_window: None,
                        boarding_duration: 0,
                        alighting_duration: 0,
                    ...
                    objects::StopTime {
                        ...
                        sequence: 4,
                        arrival_time: Some(Time::new(6, 8, 27)),
                        departure_time: Some(Time::new(6, 8, 27)),
                        start_pickup_drop_off_window: None,
                        end_pickup_drop_off_window: None,
                        boarding_duration: 0,
                        alighting_duration: 0,
                    ...
                    objects::StopTime {
                        ...
                        sequence: 5,
                        arrival_time: Some(Time::new(6, 9, 27)),
                        departure_time: Some(Time::new(6, 9, 27)),
                        start_pickup_drop_off_window: None,
                        end_pickup_drop_off_window: None,
                        boarding_duration: 0,
                        alighting_duration: 0,
