...
mod tests {
    ...
    fn equipments_serialization_deserialization() {
        test_serialize_deserialize_collection_with_id(vec![Equipment {
            ...
            elevator: gtfs_structures::Availability::Available,
            escalator: gtfs_structures::Availability::Available,
            bike_accepted: gtfs_structures::Availability::Available,
            bike_depot: gtfs_structures::Availability::Available,
            visual_announcement: gtfs_structures::Availability::Available,
            audible_announcement: gtfs_structures::Availability::Available,
            appropriate_escort: gtfs_structures::Availability::Available,
            appropriate_signage: gtfs_structures::Availability::Available,
        }]);
    }
    ...
    fn trip_properties_serialization_deserialization() {
        test_serialize_deserialize_collection_with_id(vec![
            TripProperty {
                ...
                bike_accepted: gtfs_structures::Availability::NotAvailable,
                air_conditioned: gtfs_structures::Availability::InformationNotAvailable,
                visual_announcement: gtfs_structures::Availability::Available,
                audible_announcement: gtfs_structures::Availability::Available,
                appropriate_escort: gtfs_structures::Availability::Available,
                appropriate_signage: gtfs_structures::Availability::Available,
